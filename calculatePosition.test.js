...
describe("Calculate Position", () => {
    test("it should calculate waitlist position based on referrals and how many days they have been waiting", () => {
        ...
        expect(calculatePosition(10000,2,0)).toBe(9716); // 0 referrals and 1 day
        expect(calculatePosition(10000,2,1)).toBe(8744); // 1 referrals and 2 days
        expect(calculatePosition(10000,100,1)).toBe(2134); // 1 referrals and 100 days
    });
});